...
sudo bash -c "sudo $pgm $install_command -y $php_v $php_v-{bcmath,cli,common,curl,fpm,gd,imap,mbstring,mysql,readline,redis,xml,zip}"
[ $os_id = "centos" ] && sudo $pgm $install_command -y php-json php-perl
